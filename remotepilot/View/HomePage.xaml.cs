...
namespace RemotePilot
{
    public partial class HomePage
    {
        public HomePage()
        {
            ...
            {
                new HomePageViewModel(typeof(Service), NavigateTo, BrowseSource),
                new HomePageViewModel(typeof(Operating), NavigateTo, BrowseSource),
                new HomePageViewModel(typeof(Dolly), NavigateTo, BrowseSource),
        ...
        {
            string xamlPage = "RemotePilot." + pageName + ".xaml";
